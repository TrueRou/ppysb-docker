...
create table performance_reports (
	...
	DRY_RUN_CONTAINER_time int not null,
...
create index tourney_pool_maps_tourney_pools_id_fk on tourney_pool_maps (pool_id);
...
create index tourney_pools_users_id_fk on tourney_pools (created_by);
...
values ('#osu', 'General discussion.', 1, 2, true),
	(
		'#announce',
		'Exemplary performance and public announcements.',
		1,
		24576,
		true
	),
	(
		'#lobby',
		'Multiplayer lobby discussion room.',
		1,
		2,
		false
	),
	(
		'#supporter',
		'General discussion for supporters.',
		48,
		48,
		false
	),
	(
		'#staff',
		'General discussion for staff members.',
		28672,
		28672,
		true
	),
	(
		'#admin',
		'General discussion for administrators.',
		24576,
		24576,
		true
	),
	(
		'#dev',
		'General discussion for developers.',
		16384,
		16384,
		true
	);
...
values (
		...
		'osu-combo-1000',
		'1000 Combo',
		'A thousand reasons why you rock at this game.',
...
values (
		...
		'2000 <= score.max_combo and mode_vn == 0'
	);
insert into achievements (id, file, name, `desc`, cond)
values (
		25,
